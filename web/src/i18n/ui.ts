...
export const ui = {
  en: {
    ...
    'form.firstname.ph': 'Maria',
    'form.lastname': 'Last name',
    'form.lastname.ph': 'Garcia',
    'form.zip': 'ZIP code',
    'form.zip.ph': '78701',
    'form.zip.title': 'Enter your 5-digit ZIP code.',
    'form.phone': 'Phone',
    ...
    'form.itin': 'ITIN or SSN?',
    'form.itin.help': 'Most of our readers have an ITIN and no SSN. Either is fine.',
    ...
    'form.consent.agree': 'I agree to the',
    'form.consent.tcpaLead': ', and I give my express written consent for',
    'form.consent.tcpaAnd': 'and its',
    'form.consent.partners': 'lender partners',
    'form.consent.tcpaBody': 'to contact me at the phone number and email I provided, including by autodialed or prerecorded calls and text messages, about loan and financing offers, even if my number is on a Do-Not-Call list. Consent is not a condition of any purchase. Message and data rates may apply.',
  ...
  es: {
    ...
    'form.firstname.ph': 'María',
    'form.lastname': 'Apellido',
    'form.lastname.ph': 'García',
    'form.zip': 'Código postal',
    'form.zip.ph': '78701',
    'form.zip.title': 'Ingresa tu código postal de 5 dígitos.',
    'form.phone': 'Teléfono',
    'form.phone.ph': '555-123-4567',
    ...
    'form.itin': '¿ITIN o Seguro Social?',
    'form.itin.help': 'La mayoría de nuestros lectores tiene ITIN y no Seguro Social. Cualquiera está bien.',
    ...
    'form.consent.agree': 'Acepto la',
    'form.consent.tcpaLead': ', y doy mi consentimiento expreso por escrito para que',
    'form.consent.tcpaAnd': 'y sus',
    'form.consent.partners': 'prestamistas asociados',
    'form.consent.tcpaBody': 'me contacten al teléfono y correo que proporcioné, incluso mediante llamadas o mensajes de texto automatizados o pregrabados, sobre ofertas de préstamos y financiamiento, aunque mi número esté en una lista de No Llamar. El consentimiento no es condición para ninguna compra. Pueden aplicar tarifas de mensajes y datos.',
