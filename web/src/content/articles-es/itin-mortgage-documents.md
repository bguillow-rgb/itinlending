---
title: "Lista de Documentos para Hipoteca con ITIN (Guía 2026)"
description: "Sí, puedes obtener una hipoteca con ITIN. Aquí está la lista exacta de documentos que los prestamistas exigen en 2026: ingresos, identificación, crédito y más."
tier: detail
targetQuery: "qué documentos necesito para una hipoteca con ITIN"
relatedQueries:
  - "requisitos de documentación para hipoteca con ITIN"
  - "cómo comprobar ingresos para préstamo hipotecario con ITIN"
  - "documentos para préstamo ITIN trabajador independiente"
  - "hipoteca con estados de cuenta bancarios e ITIN"
...
faqs:
  ...
  - q: "¿Cuántos años de declaraciones de impuestos piden los prestamistas de hipotecas con ITIN?"
    a: "La mayoría de los prestamistas solicita los últimos dos años de declaraciones federales de impuestos presentadas con tu ITIN (Formulario 1040 con W-7). Si trabajas por cuenta propia, algunos prestamistas aceptan en su lugar de 12 a 24 meses de estados de cuenta bancarios."
  - q: "¿Mi pasaporte tiene que ser estadounidense?"
    a: "No. Los pasaportes extranjeros se aceptan como identificación principal en las hipotecas con ITIN. No necesitas una identificación emitida en EE. UU.; el pasaporte solo debe estar vigente y en buen estado."
  - q: "¿Qué es una 'línea de crédito alternativa' y cómo la documento?"
    a: "Una línea de crédito alternativa es una cuenta de pago recurrente que no aparece en los principales burós de crédito. Algunos ejemplos son la renta, la electricidad, el teléfono celular o el seguro de auto. Para documentarlas, presenta 12 meses de cheques cancelados, impresiones de estados de cuenta bancarios que muestren pagos consistentes, o una carta de referencia escrita por quien recibe el pago."
  - q: "¿Los prestamistas aceptan fondos de regalo para el enganche de una hipoteca con ITIN?"
    a: "Algunos prestamistas sí aceptan fondos de regalo para una parte del enganche. Por lo general necesitarás una carta de donación firmada que indique que el dinero es un regalo y no un préstamo, junto con comprobante de la transferencia. No todos los programas de ITIN permiten fondos de regalo, así que confirma esto con tu prestamista."
  - q: "¿Qué tipos de propiedades califican para una hipoteca con ITIN?"
    a: "La mayoría de los programas de ITIN cubren residencias primarias, pero algunos prestamistas también financian segundas residencias e inmuebles de inversión. Los requisitos de enganche suelen ser más altos para compras que no sean residencia principal."
published: true
---
...
| Perfil crediticio | Enganche típico | Notas |
|---|---|---|
...
| Propiedad de inversión | 25%+ | La mayoría de los prestamistas exige más para uso no primario |
...
| Categoría de documento | Qué presentar |
|---|---|
| **Identidad** | Carta de asignación del ITIN + identificación oficial con foto (extranjera o de EE. UU.) |
...
| **Empleo** | Historial de 2 años; carta del empleador si se solicita |
| **Crédito** | Reporte de crédito de EE. UU. (mín. 580-620+) O 12 meses de líneas de crédito alternativas |
| **Activos / Enganche** | 2-3 meses de estados de cuenta bancarios de todas las cuentas; carta de donación si aplica |
| **Residencia** | Facturas de servicios públicos, contrato de arrendamiento o estados de cuenta que muestren dirección en EE. UU. |
| **Propiedad** | Contrato de compraventa (una vez bajo contrato); documentos de la HOA si aplica |
...
Para una visión más amplia de qué esperar durante la solicitud, consulta nuestra guía sobre [cómo calificar para una hipoteca con ITIN](/es/articles/itin-mortgage-qualify). Y si todavía estás trabajando en construir tu historial crediticio antes de solicitar, nuestra [guía para construir crédito con ITIN](/es/articles/how-to-build-credit-with-itin) explica los caminos legales más rápidos para obtener un expediente con puntaje.
