...
relatedQueries:
  - "rentar apartamento sin número de Seguro Social"
  - "proceso de selección de inquilinos con ITIN"
  - "solicitud de apartamento sin SSN"
  - "cómo pasar verificación de antecedentes para renta con ITIN"
...
faqs:
  ...
  - q: "¿Aparecerá mi ITIN en el reporte de selección de inquilinos?"
    a: "No. Las plataformas de selección como TransUnion SmartMove aceptan el ITIN para localizar tu expediente, pero el número en sí no aparece en el reporte que recibe el arrendador. Lo que se muestra es tu historial de pagos y tus cuentas de crédito."
  - q: "¿Qué puntaje de crédito necesito para rentar un apartamento con ITIN?"
    a: "La mayoría de los arrendadores prefieren un puntaje superior a 620-650, pero un titular de ITIN con historial limitado aún puede ser aprobado si ofrece un depósito de seguridad mayor, un cofirmante o varios meses de renta por adelantado, junto con documentación sólida de ingresos."
  - q: "¿Cómo puedo construir un historial crediticio para que futuras solicitudes de renta sean más fáciles?"
    a: "Abre una tarjeta de crédito asegurada que acepte ITIN, págala en su totalidad cada mes y agrega un préstamo para construir crédito. Nuestra guía sobre cómo construir crédito con ITIN explica la estrategia completa paso a paso."
  - q: "¿Puedo rentar si tengo ITIN pero ningún historial crediticio en EE. UU.?"
    a: "Sí. Ofrece 2-3 meses de renta por adelantado o un depósito de seguridad mayor, presenta 3-6 meses de estados de cuenta bancarios que muestren saldos suficientes y lleva referencias de arrendadores de tu país de origen o una carta de tu empleador local. Muchos arrendadores privados aprueban este paquete sin necesidad de un reporte de crédito."
published: true
---
...
1. **Comunícate directamente con la oficina de arrendamiento.** Explica que tienes ITIN y pregunta si pueden aceptar una solicitud manual o ejecutar la verificación a través de un servicio que lo admita. Muchos agentes ya han manejado esta situación y te ayudarán.
2. **Ofrece presentar tu propio reporte de crédito.** Solicita tu reporte en AnnualCreditReport.com o usa un servicio como Nova Credit (que traduce historiales crediticios del extranjero para arrendadores en EE. UU.) y entrégaselo directamente al arrendador.
3. **Usa plataformas diseñadas para solicitantes con ITIN.** Para rentar, el ITIN es importante porque la mayoría de las plataformas de renta en línea y servicios de selección tienen un campo para SSN o ITIN, y sin ninguno de los dos, tu solicitud puede ser rechazada antes de que un humano la lea; sin embargo, grandes administradoras de propiedades como Greystar aceptan explícitamente visa, tarjeta verde o ITIN como identificación alternativa para residentes no estadounidenses.
4. **Aplica en persona en propiedades más pequeñas.** Los arrendadores independientes con dos o tres unidades rara vez usan portales automatizados, y una conversación en persona te permite presentar tu situación financiera completa.
...
**¿Puede un arrendador rechazarme legalmente solo porque tengo ITIN en vez de SSN?**
No por origen nacional. La Fair Housing Act prohíbe que los arrendadores nieguen vivienda por el lugar de nacimiento de una persona. El arrendador puede establecer requisitos financieros, pero no puede rechazarte únicamente por ser inmigrante o no ciudadano.

**¿Aparecerá mi ITIN en el reporte de selección de inquilinos?**
No. Las plataformas de selección que aceptan ITIN lo usan para localizar tu expediente, pero el número en sí no aparece en el reporte que recibe el arrendador. Lo que se muestra es tu historial de pagos y tus cuentas de crédito.

**¿Qué puntaje de crédito necesito para rentar un apartamento con ITIN?**
...
Abre una tarjeta de crédito asegurada que acepte ITIN, págala en su totalidad cada mes y agrega un préstamo para construir crédito. Nuestra guía sobre [cómo construir crédito con ITIN](/es/articles/how-to-build-credit-with-itin) explica la estrategia completa.
