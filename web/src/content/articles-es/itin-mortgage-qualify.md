---
title: "Cómo calificar para una hipoteca con ITIN (Guía 2026)"
description: "Sí puedes calificar para una hipoteca con ITIN sin tener SSN. Conoce los requisitos exactos de ingresos, crédito, enganche y documentación que usan los prestamistas en 2026."
tier: detail
targetQuery: "cómo calificar para una hipoteca con ITIN"
relatedQueries:
  - "requisitos para hipoteca con ITIN 2026"
  - "cómo obtener un préstamo hipotecario con ITIN"
...
howToSteps:
  ...
  - name: "Construye tu perfil de crédito, tradicional o alternativo"
    text: "La mayoría de los programas buscan un puntaje de crédito en EE. UU. de 620+. Muchos prestamistas con ITIN aceptan documentación de crédito alternativo en su lugar, como 12 meses de pagos puntuales de renta, servicios o teléfono."
  - name: "Documenta tus ingresos"
    text: "Los empleados W-2 entregan talones de pago. Los trabajadores independientes suelen traer de 12 a 24 meses de estados de cuenta personales o del negocio, estados de pérdidas y ganancias, o registros del Formulario 1099."
  - name: "Ahorra tu enganche"
    text: "La mayoría de los programas de hipoteca con ITIN piden entre 10%-20% de enganche para una residencia principal con buen crédito. Con crédito más débil o propiedades de inversión eso puede subir a 25% o más. Los fondos generalmente deben estar \"madurados\" 30-60 días."
  - name: "Reúne tu documentación"
    text: "Junta tu aviso de ITIN (CP565 del IRS o equivalente), pasaporte o identificación oficial, dos años de declaraciones de impuestos, comprobante de ingresos, estados de cuenta del enganche madurado, y cualquier documentación de crédito alternativo antes de solicitar."
  - name: "Solicita con un prestamista de portafolio (non-QM)"
    text: "Las hipotecas con ITIN son préstamos de portafolio non-QM. No cumplen con los lineamientos de FHA, VA, USDA, Fannie Mae ni Freddie Mac, así que el prestamista mantiene el préstamo en sus propios libros. Los criterios de calificación y las tasas cambian bastante entre prestamistas, así que compara más de uno."
published: true
---
...
## ¿Cuáles son los requisitos principales para calificar a una hipoteca con ITIN en 2026?

La elegibilidad para una hipoteca con ITIN se basa en demostrar estabilidad financiera y capacidad de pago. Necesitarás un ITIN válido y vigente, además de al menos dos años de declaraciones de impuestos federales presentadas que muestren ingresos consistentes.

Más allá de esos dos pilares fundamentales, la mayoría de los programas evalúan cinco factores adicionales:

| Requisito | Base típica | Perfil sólido |
|---|---|---|
...
Si estás construyendo activamente tu historial de crédito en EE. UU. antes de solicitar, consulta nuestra guía sobre [cómo construir crédito con un número ITIN](/es/articles/how-to-build-credit-with-itin), incluso 12 meses de pagos puntuales con una tarjeta asegurada pueden satisfacer el umbral de crédito alternativo en muchos prestamistas.

## ¿Cómo verifican los prestamistas los ingresos para una hipoteca con ITIN?

Aquí es donde la suscripción de hipotecas con ITIN se aleja más de las reglas de los préstamos convencionales. Los programas de hipoteca con ITIN funcionan de manera diferente porque están diseñados para prestatarios que pueden generar ingresos en el extranjero, operar negocios de forma independiente o tener perfiles financieros fuera de las estructuras de préstamo convencionales. En lugar de enfocarse estrictamente en un puntaje FICO en EE. UU. o en documentación de nómina estándar, los prestamistas pueden evaluar la posición financiera general del prestatario, incluyendo fondos de reserva, historial bancario, activos disponibles y solidez general de pago.

Así se desglosa la documentación de ingresos según el tipo de empleo:
...
| Categoría del documento | Qué presentar |
|---|---|
| Verificación del ITIN | Aviso CP565 del IRS o carta oficial de confirmación del ITIN |
...
1. **ITIN vencido o inactivo.** Renuévalo mediante el Formulario W-7 con suficiente tiempo antes de solicitar.
2. **Ingresos inconsistentes:** grandes interrupciones en el empleo o depósitos bancarios irregulares que no se pueden explicar o documentar claramente.
...
**¿Las hipotecas con ITIN son préstamos FHA o convencionales?**
