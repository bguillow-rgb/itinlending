...
relatedQueries:
  - "prestamistas de préstamos para negocios con ITIN 2026"
  - "préstamo de negocios con ITIN sin SSN"
  - "préstamos para inmigrantes sin seguro social"
  - "préstamos CDFI para personas con ITIN"
  - "elegibilidad préstamo SBA con ITIN 2026"
quickAnswer: "Puedes obtener un préstamo de negocios con tu ITIN a través de CDFIs como Accion Opportunity Fund ($5K-$250K), DreamSpring ($1K-$2M) y Kiva (0% hasta $15K). A partir del 1 de marzo de 2026, los préstamos SBA 7(a) y 504 requieren que el 100% de los dueños sean ciudadanos estadounidenses, por lo que ya no están disponibles para personas con ITIN ni para titulares de green card."
...
faqs:
  ...
  - q: "¿Los titulares de ITIN pueden solicitar préstamos del SBA en 2026?"
    a: "No. A partir del 1 de marzo de 2026, el SBA modificó sus reglas para exigir que el 100% de los dueños de la empresa sean ciudadanos estadounidenses en todos los programas de préstamos 7(a), 504 y Express. Las personas con ITIN, los titulares de green card y otros no ciudadanos quedan excluidos de todos los programas garantizados por el SBA."
  - q: "¿Cuál es el préstamo de negocios más fácil de obtener con un ITIN?"
    a: "Kiva U.S. suele tener el proceso más accesible: 0% de interés, hasta $15,000, sin puntaje de crédito mínimo y sin garantía requerida. La desventaja es el tiempo de financiamiento colectivo, que toma entre 30 y 45 días. Si necesitas dinero más rápido o en cantidades mayores, Accion Opportunity Fund o DreamSpring son las mejores opciones."
  - q: "¿Cuánto dinero puedo pedir prestado para mi negocio con un ITIN?"
    a: "Los montos varían mucho: Kiva U.S. presta hasta $15,000 al 0%; Accion Opportunity Fund hasta $250,000; DreamSpring hasta $2,000,000 para negocios establecidos; y Pursuit (corredor del noreste) hasta $500,000. El monto al que puedes acceder depende de tus ingresos, el tiempo que llevas operando y tu perfil de crédito."
  - q: "¿Necesito una garantía para un préstamo de negocios con ITIN?"
    a: "No siempre. Kiva U.S. y Camino Financial (para dueños minoritarios con SSN) no requieren garantía. Accion Opportunity Fund coloca un gravamen general sobre préstamos de $50,000 en adelante. DreamSpring puede pedir garantía en montos más grandes. Confirma los requisitos con cada prestamista antes de aplicar."
  - q: "¿Qué documentos necesito para solicitar un préstamo de negocios con ITIN?"
    a: "Por lo general necesitas: la carta de asignación del ITIN del IRS (CP565) o una declaración de impuestos reciente que muestre tu ITIN, un pasaporte válido o identificación consular, estados de cuenta bancarios del negocio (6 a 12 meses), documentos de registro del negocio (EIN, actas constitutivas o documentos de LLC) y declaraciones de impuestos del negocio de 1 a 2 años si las tienes disponibles."
  - q: "¿Puedo obtener un Microloan del SBA con un ITIN?"
    a: "El programa de Microloans del SBA también fue afectado por el cambio de reglas de marzo de 2026, que restringe los programas del SBA a ciudadanos estadounidenses. Sin embargo, muchos de los prestamistas intermediarios sin fines de lucro que distribuyen los microloans del SBA también son CDFIs que tienen sus propios productos de préstamos accesibles con ITIN y sin respaldo del SBA. Te recomendamos contactar directamente al intermediario de tu área."
  - q: "¿Tener un EIN me ayuda a calificar para un préstamo de negocios sin SSN?"
    a: "Sí. Un EIN (Número de Identificación del Empleador) es indispensable: separa la identidad de tu negocio de tu ITIN personal, te permite abrir una cuenta bancaria empresarial, presentar declaraciones de impuestos del negocio y solicitar permisos. La mayoría de los CDFIs y prestamistas alternativos exigen un EIN, no solo tu ITIN personal, al evaluar una solicitud de préstamo comercial."
  - q: "¿Qué tasa de interés pagaré en un préstamo de negocios con ITIN?"
    a: "Las tasas varían según el tipo de prestamista: Kiva U.S. cobra 0%. Los CDFIs como Accion Opportunity Fund cobran entre 9.99% y 28.99%. Las tasas de DreamSpring varían y algunos prestatarios han reportado APRs superiores al 30%. Los prestamistas en línea que no son CDFI suelen cobrar entre 32% y 45% APR. Comparar al menos dos o tres opciones de CDFI primero es la mejor manera de reducir costos."
  - q: "¿Un trabajador independiente con ITIN puede obtener un préstamo de negocios?"
    a: "Sí, aunque los requisitos son más estrictos. Los CDFIs y los microprestamistas son tu mejor opción. Tendrás que documentar los ingresos del negocio por separado de los personales, mostrar depósitos consistentes en una cuenta bancaria exclusiva para el negocio y, en muchos casos, demostrar al menos 9 a 12 meses de historial operativo. Constituir el negocio como una LLC antes de aplicar suele mejorar las posibilidades de aprobación."
published: true
---
...
| Prestamista | Tipo | Acepta ITIN | Rango de préstamo | Rango de tasas | Ingresos mínimos | Tiempo mínimo operando |
|---|---|---|---|---|---|---|
| DreamSpring | CDFI (sin fines de lucro) | Sí | $1,000 - $2,000,000 | Varía (algunos reportes de APRs altos) | No publicado | Cualquier etapa |
| Pursuit | CDFI (Noreste) | Sí | Hasta $500,000 | Varía según el programa | No publicado | Varía |
| Accion Opportunity Fund | CDFI (sin fines de lucro) | Sí | $5,000 - $250,000 | 9.99% - 28.99% | $50K-$100K/año | 12 meses |
| Kiva U.S. | Microloan por financiamiento colectivo | Sí | $1,000 - $15,000 | 0% | Ninguno | Ninguno |
| LEDC | CDFI (DC/MD/VA) | Sí | Micro a mediano | Tasas con enfoque social | Varía | Varía |
| Accompany Capital | CDFI (NYC) | Sí (sin puntaje mínimo) | $1,000 - $350,000 | Varía | No especificado | No especificado |
| SBA 7(a) / 504 | Federal | No (desde el 3/1/2026) | Hasta $5M / $5.5M | Prime + margen | Varía | 2 años o más |
| SBA Microloan | Intermediario federal | Restringido (ver nota) | Hasta $50,000 | 8% - 13% | Ninguno | Apto para startups |
...
| Documento | Por qué es necesario | Quién lo exige |
|---|---|---|
| Carta de ITIN del IRS (CP565) o declaración de impuestos que muestre el ITIN | Confirma tu identidad fiscal | Todos los CDFIs |
| Pasaporte válido o identificación consular (Matrícula Consular) | Identificación emitida por el gobierno | Todos los prestamistas |
| EIN (Número de Identificación del Empleador) | Separa la identidad del negocio de la personal | La mayoría de los prestamistas |
| Estados de cuenta bancarios del negocio (6 a 12 meses) | Demuestra ingresos y flujo de caja | Accion, DreamSpring, la mayoría de los CDFIs |
| Registro del negocio / documentos de LLC | Demuestra que el negocio existe legalmente | Todos los prestamistas |
| Declaraciones de impuestos del negocio de 1 a 2 años | Documenta el historial de ingresos | Requerido para préstamos mayores |
| Plan de negocios (para startups) | Demuestra viabilidad | Kiva, algunos CDFIs |
...
| Categoría de prestamista | Rango típico de APR | Garantía requerida | Rango de monto del préstamo |
|---|---|---|---|
...
| SBA 7(a) | Cerrado para titulares de ITIN | Sí | N/A |
