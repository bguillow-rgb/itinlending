...
relatedQueries:
  - "how to send money abroad without a Social Security number"
  - "best remittance app for ITIN holders"
  - "can undocumented immigrants send money internationally"
  - "ITIN wire transfer requirements 2026"
...
relatedSlugs:
  ...
  - "itin-bank-account"
faqs:
  - q: "Do I need an SSN to send money internationally from the U.S.?"
    a: "No. Major remittance services including Wise, Remitly, Western Union, and Xoom accept passport-based identity verification and an ITIN in place of a Social Security number."
  - q: "Does the new 2026 remittance tax apply to ITIN holders?"
    a: "The 1% federal excise tax introduced January 1, 2026 applies to transfers funded with cash, money orders, or cashier's checks. It does not apply to electronic transfers funded from a U.S. bank account or debit card, regardless of whether the sender has an SSN or ITIN."
  - q: "What documents do I need to open a Wise or Remitly account with an ITIN?"
    a: "Typically a valid foreign passport or government-issued photo ID plus your ITIN. Some providers also ask for proof of a U.S. address for higher transfer limits."
  - q: "Is there a limit on how much I can send internationally with an ITIN?"
    a: "There is no federal cap on the amount you can send. However, providers set their own per-transaction and daily limits, and transfers over $10,000 are automatically reported to the IRS by the financial institution, regardless of immigration status."
  - q: "Which remittance app is cheapest for ITIN holders sending money to Latin America?"
    a: "Wise, Remitly, and Xoom all have strong coverage for Mexico, Colombia, and Central America. Wise typically offers the lowest all-in cost because it uses the mid-market exchange rate. Always compare the actual amount your recipient receives, not just the headline fee."
published: true
---
...
| Provider | Accepts ITIN? | Best For | Typical Cost vs. Bank Wire |
|---|---|---|---|
| **Wise** | Yes | Low fees, mid-market rate | 0.3%-2% total cost |
| **Remitly** | Yes | Speed, cash pickup in LatAm | Competitive on popular corridors |
| **Western Union** | Yes | Cash pickup, broad agent network | Higher fees than digital apps |
| **Xoom (PayPal)** | Yes | Mexico, Latin America, Philippines | Good rates on key corridors |
| **B9 (app)** | Yes (ITIN or SSN) | Cash advances + transfers | Monthly membership fee applies |
| **Bank wire** | Yes (with ITIN account) | Large amounts over $50,000 | $25-$50 fee plus 2%-4% FX markup |
...
**Do I need an SSN to send money internationally from the U.S.?**
No. Major remittance services including Wise, Remitly, Western Union, and Xoom accept passport-based identity verification and an ITIN in place of a Social Security number.

**Does the new 2026 remittance tax apply to ITIN holders?**
The 1% federal excise tax introduced January 1, 2026 applies to transfers funded with cash, money orders, or cashier's checks. It does not apply to electronic transfers funded from a U.S. bank account or debit card, regardless of whether the sender has an SSN or ITIN.

**What documents do I need to open a Wise or Remitly account with an ITIN?**
Typically a valid foreign passport or government-issued photo ID plus your ITIN. Some providers also ask for proof of a U.S. address for higher transfer limits.

**Is there a limit on how much I can send internationally with an ITIN?**
There is no federal cap on the amount you can send. However, providers set their own per-transaction and daily limits, and transfers over $10,000 are automatically reported to the IRS by the financial institution, regardless of immigration status.

**Which remittance app is cheapest for ITIN holders sending money to Latin America?**
Wise, Remitly, and Xoom all have strong coverage for Mexico, Colombia, and Central America. Wise typically offers the lowest all-in cost because it uses the mid-market exchange rate. Always compare the actual amount your recipient receives, not just the headline fee.
