---
title: "How to Open a Bank Account With an ITIN (2026 Guide)"
description: "Yes, you can open a U.S. bank account with an ITIN. Learn which banks accept ITINs, what documents you need, and how the 2026 rules affect ITIN holders."
tier: detail
targetQuery: "how to open a bank account with an ITIN number"
relatedQueries:
  - "can you open a bank account with an ITIN"
  - "which banks accept ITIN for bank account"
  - "bank account without SSN immigrants"
  - "ITIN bank account requirements 2026"
...
faqs:
  ...
  - q: "What documents do I need to open a bank account with an ITIN?"
    a: "You'll typically need: (1) your ITIN assignment letter from the IRS, (2) a valid foreign passport or government-issued photo ID, (3) a second form of ID such as a consular card or state-issued ID, and (4) proof of a U.S. address such as a utility bill or lease. Requirements vary by bank, so call ahead."
  - q: "Will banks report my immigration status to the government if I open an account with an ITIN?"
    a: "Not currently. The Right to Financial Privacy Act requires banks to have a legal process such as a subpoena before sharing your financial records with any government agency. A 2026 Trump executive order directs future Treasury guidance on ITIN accounts, but no final rules have taken effect as of June 2026."
  - q: "Does opening a bank account with an ITIN help build credit?"
    a: "A bank account itself doesn't directly build credit, but it lays the foundation. Having documented bank history helps you qualify for ITIN credit cards and loans, which do report to the credit bureaus. Pairing a checking account with a secured credit card or credit-builder loan is the fastest path to a U.S. credit score."
  - q: "Can I open a bank account with an ITIN online, or do I have to go in person?"
    a: "In most cases you'll need to visit a branch in person. Most banks' online account-opening systems are built for SSN holders and won't process ITIN applications. Call ahead to confirm documents and schedule an appointment so you're seen by a banker who is familiar with the process."
  - q: "How long does it take to get an ITIN from the IRS?"
    a: "The IRS typically processes ITIN applications in about 7 weeks. During peak tax season (January 15–April 30) or when applying from abroad, processing can take 9 to 11 weeks. The IRS recommends applying at least 45 days before you need to file a tax return."
published: true
---
...
## Is it actually legal to open a bank account without an SSN?
...
| Institution Type | Accepts ITIN? | In-Person Required? | Notes |
|---|---|---|---|
| Bank of America | ✅ Yes | Usually | Two forms of ID + proof of address |
| Chase | ✅ Yes | Usually | May accept alternative ID in-branch |
| Wells Fargo | ✅ Yes | Usually | Spanish-language support available |
| Citibank | ✅ Yes | Usually | Accepts ITIN; links to international Citi accounts |
| PNC Bank | ✅ Yes | Usually | Can provide IRS Form W-8 BEN if no ITIN |
| Community credit unions | ✅ Often | Sometimes | Most flexible; accept consular IDs |
| Online-only banks | ⚠️ Limited | No | Some fintech platforms expanding; confirm first |
