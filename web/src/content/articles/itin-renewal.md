...
faqs:
  ...
  - q: "Does my ITIN number change when I renew it?"
    a: "No. The IRS keeps your same nine-digit number after renewal — it simply reactivates the existing number. Any bank accounts, credit accounts, or loan records tied to your ITIN do not need to be updated."
  - q: "Can I apply for a mortgage or loan while my ITIN renewal is pending?"
    a: "Most lenders will not approve a mortgage, car loan, or personal loan application tied to an expired ITIN. You should wait until the IRS confirms your renewal before submitting a loan application to avoid an automatic rejection."
  - q: "How much does it cost to renew an ITIN?"
...
1. **Look at the middle digits.** ITINs with middle digits 70–88 have all expired, regardless of when they were issued. The IRS periodically retires additional ranges, so always verify the current list at irs.gov/itin.
