...
relatedQueries:
  - "itin holder retirement savings account"
  - "open roth ira without social security number"
  - "can immigrants contribute to IRA"
  - "retirement account for non citizens USA"
  - "itin 401k options"
...
faqs:
  ...
  - q: "How much can an ITIN holder contribute to an IRA in 2026?"
    a: "The 2026 IRA contribution limit is $7,500 per year if you are under age 50, and $8,600 per year if you are 50 or older. These limits apply equally to SSN and ITIN holders, there is no separate lower cap for ITIN filers."
  - q: "Does my immigration status affect IRA eligibility?"
    a: "No. The IRS does not require U.S. citizenship or permanent residency to contribute to an IRA. What matters is having a valid taxpayer identification number (SSN or ITIN) and earned income that is subject to U.S. taxation."
  - q: "Can ITIN holders participate in a 401(k) at work?"
    a: "There is no IRS rule that bars ITIN holders from a 401(k), but participation depends on the employer's payroll system. If that system requires an SSN to process contributions, you may be unable to enroll even if otherwise eligible, making an IRA your best alternative."
  - q: "What counts as 'earned income' for IRA contributions if I have an ITIN?"
    a: "Earned income means wages, salaries, tips, net self-employment income, or other compensation subject to U.S. taxes. Investment returns, dividends, and income earned outside the U.S. do not qualify, even if you reported them to the IRS."
published: true
---
...
| IRA Type | 2026 Limit (Under 50) | 2026 Limit (50+) | ITIN Accepted? |
|---|---|---|---|
| Traditional IRA | $7,500 | $8,600 | ✅ Yes |
| Roth IRA | $7,500 | $8,600 | ✅ Yes |
| SIMPLE IRA (employer) | $17,000 | $21,000 | Depends on employer |
| 401(k) (employer) | $24,500 | $32,500 | Depends on employer |
...
**Can I open a Roth IRA with an ITIN instead of an SSN?**
Yes. The IRS permits ITIN holders to contribute to both Traditional and Roth IRAs, provided you have U.S.-sourced taxable earned income. Not all brokerage platforms support ITIN onboarding, so choose one that explicitly accepts it, such as Finhabits.

**How much can an ITIN holder contribute to an IRA in 2026?**
The 2026 IRA contribution limit is $7,500 per year if you are under age 50, and $8,600 per year if you are 50 or older. These limits apply equally to SSN and ITIN holders.

**Does my immigration status affect IRA eligibility?**
No. The IRS does not require U.S. citizenship or permanent residency. What matters is a valid ITIN and earned income subject to U.S. taxation.

**Can ITIN holders participate in a 401(k) at work?**
There is no IRS rule that bars you, but participation depends on whether your employer's payroll system can process contributions without an SSN. If not, an IRA is your best alternative.

**What counts as 'earned income' for IRA contributions if I have an ITIN?**
Wages, salaries, tips, and net self-employment income subject to U.S. taxes all qualify. Investment returns, dividends, and income earned exclusively outside the U.S. do not count.
