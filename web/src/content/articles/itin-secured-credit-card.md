---
title: "Can You Get a Secured Credit Card With an ITIN? (2026)"
description: "Yes, ITIN holders can get a secured credit card without an SSN. Compare top cards, deposit requirements, and how each one reports to the credit bureaus."
tier: detail
targetQuery: "can I get a secured credit card with an ITIN number"
relatedQueries:
  - "secured credit card no SSN required"
  - "best secured credit card for immigrants 2026"
  - "how to build credit in the US with an ITIN"
  - "secured credit card no credit history ITIN"
...
faqs:
  ...
  - q: "How much of a security deposit do I need for a secured card as an ITIN holder?"
    a: "Most secured cards require a minimum deposit of $200. Some cards, like the Discover it Secured, allow deposits up to $2,500, which directly sets your credit limit. The deposit is fully refundable when you close or graduate to an unsecured account."
  - q: "Will a secured credit card build my U.S. credit score if I only have an ITIN?"
    a: "Yes, provided the issuer reports to the three major bureaus (Experian, TransUnion, and Equifax). Most major secured cards do. After roughly 6-12 months of on-time payments and low balances, many ITIN holders see scores in the 660-720 range."
  - q: "What documents does an ITIN holder need to apply for a secured credit card?"
    a: "Typically: your ITIN letter from the IRS, a foreign passport or government-issued photo ID, a U.S. mailing address, and a bank account to fund the security deposit. Some issuers may also ask for proof of income."
  - q: "How long before I can upgrade from a secured card to an unsecured card with an ITIN?"
    a: "Most issuers review your account after 6-12 months of responsible use. Capital One typically reviews at the 6-month mark, while Discover automatically reviews at 7 months. Upgrading is not guaranteed but is common when you pay on time and keep your balance low."
  - q: "Does getting a secured credit card with an ITIN affect my immigration status?"
    a: "No. An ITIN is a tax-processing number issued by the IRS and is separate from immigration status. Using it to open a credit card account does not create any immigration record or affect any visa or status determination."
published: true
---
...
| Card | Minimum Deposit | Annual Fee | Reports to All 3 Bureaus | Upgrade Path |
|---|---|---|---|---|
| Capital One Quicksilver Secured | $200 | $0 | Yes | 6-month review |
| Discover it Secured | $200 | $0 | Yes | 7-month automatic review |
| Bank of America Customized Cash Secured | $300 | $0 | Yes | Periodic review |
| Firstcard Secured Builder | $0 (no minimum) | $0 | Yes (all 3) | No formal upgrade; apply for new card |
| U.S. Bank Secured Visa | $300 | $0 | Yes | Annual review |
