...
description: "Yes, ITIN holders can check their credit score, but the process differs from SSN holders. This step-by-step guide shows you exactly how to access all 3 bureaus."
tier: detail
targetQuery: "how to check my credit score with an ITIN number"
relatedQueries:
  - "check credit report with ITIN no SSN"
  - "ITIN credit score Experian Equifax TransUnion"
  - "can I get a free credit report with an ITIN"
  - "does ITIN holder have credit score"
...
faqs:
  ...
  - q: "Can I use AnnualCreditReport.com to check my credit with an ITIN?"
    a: "No. AnnualCreditReport.com's online system only accepts Social Security Numbers. As an ITIN holder, you must contact Equifax, Experian, and TransUnion directly, by mail, phone, or (for Equifax) through its online portal at my.equifax.com."
  - q: "Will checking my own credit score hurt my credit?"
    a: "No. Requesting your own credit report or score is classified as a soft inquiry and has zero effect on your credit score, regardless of how often you do it."
  - q: "How long does it take to get a credit report by mail as an ITIN holder?"
    a: "Typically two to four weeks after the bureau receives your written request. Include copies (never originals) of your government-issued ID and a utility bill or bank statement to avoid delays."
  - q: "What if my ITIN is not linked to any credit accounts yet?"
    a: "If you have never opened a credit card, loan, or other account that reports to a U.S. bureau, you likely have no credit file yet. You would need to start building credit first, for example, with a secured credit card or a credit-builder loan, before a score can be generated. See our guide on how to build credit with an ITIN for a step-by-step plan."
  - q: "Can I transfer my ITIN credit history to an SSN if I later get one?"
    a: "Yes, but it does not happen automatically. You must contact all three credit bureaus in writing and request that your credit history be linked from your ITIN to your new Social Security Number."
published: true
---
