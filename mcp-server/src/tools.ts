/**
 * Tool registration shared by both transports: the stdio npm package
 * (src/index.ts) and the Supabase Edge Function (supabase/functions/mcp/),
 * which imports the COMPILED build of this file (dist/tools.js). Re-copy
 * dist/*.js into the function dir whenever this changes.
 */
